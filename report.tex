...
\end{figure}
\begin{figure}[h]
\includegraphics[height=4cm]{Matlab_Pendulum1.png}
\centering
...
\begin{table}[h!]
  ...
  \begin{tabular}{c c}
      ...
      \includegraphics[height=3cm]{pythagora.png}
      \centering
      \captionof{figure}{Two weights pythagorean theorem}
    \end{minipage}
 &
  \begin{minipage}{0.5\textwidth}
      \includegraphics[height=3cm]{CollisionManagementEdited.png}
      \centering
...
\begin{table}[h!]
  \begin{tabular}{c c}
    \begin{minipage}{0.5\textwidth}
      \includegraphics[height=3cm]{collisionplane.png}
      \centering
      \captionof{figure}{Collision plane}
    \end{minipage}
    &
  \begin{minipage}{0.5\textwidth}
      \includegraphics[height=3cm]{newvelocitiesvectors_new.png}
      \centering
      \captionof{figure}{Modified idea}
    \end{minipage} \\
  \end{tabular}
...
\begin{table}[h!]
  ...
  \begin{tabular}{c  c}
        \begin{minipage}{0.5\textwidth}
      \includegraphics[width=\linewidth, width=60mm]{Matlab_Pendulum1.png}
      \centering
%      \captionsetup{justification=raggedright, singlelinecheck=false}
    ...
    & 
  \begin{minipage}{0.5\textwidth}
      \includegraphics[width=\linewidth, width=60mm]{Matlab_Pendulum2.png}
%      \centering
      \captionsetup{justification=raggedright, singlelinecheck=false}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=100mm]{OpenGL_pendulum0.png}
 \caption{FIRZT}
%\label{overflow}
\end{figure}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=100mm]{OpenGL_bounce0.png}
 \caption{}
%\label{overflow}
\end{figure}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=100mm]{OpenGL_pendulum1.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[width=100mm]{OpenGL_bounce1.png}
 \caption{BALLZ}
%\label{overflow}
\end{figure}
